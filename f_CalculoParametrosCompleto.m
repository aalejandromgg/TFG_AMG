function [alpha, beta, gamma, delta,distancias_ks] = f_CalculoParametrosCompleto(datos, ventana, metodo)
    ...
    num_ventanas = length(datos) - size_ventana + 1; % Calcular el número total de ventanas posibles
